...
contract uniLockFactory  {
    ...
    uint public balance_required;
    uint public high_tier;
    uint public medium_tier;
    uint public low_tier;
    
    constructor(address _UNL,uint min_balance,uint _fee,address _uniRouter,uint _high_tier,uint _medium_tier,uint _low_tier) public {
        ...
        high_tier = _high_tier;
        medium_tier = _medium_tier;
        low_tier = _low_tier;
    }
...
*/     return true;
   ...
   function changeConfig(uint _fee,address _to,uint _balance_required,address _uni_router,address _unl_address,address _signer,uint _high_tier,uint _medium_tier,uint _low_tier) public only_factory_Owner returns(uint){
        fee = _fee;
        toFee = _to;
